...
* **State**: Document is at RFC editor state
* **Mailinglist**: https://mailarchive.ietf.org/arch/browse/ippm/?q=draft-ietf-nmop-terminology
* **Diff**: https://author-tools.ietf.org/diff?doc_1=draft-ietf-nmop-terminology
* **IETF Session**: No
...
* **State**: IETF 125 hackathon https://mailarchive.ietf.org/arch/browse/nmop/?q=draft-ietf-nmop-yang-message-broker-integration announced. Reshad reviewed document and authors adressed https://mailarchive.ietf.org/arch/msg/nmop/FvjNXKJntt3gACR45RhaESUzgi8/. Authors requested working group last call. All netconf working group related normative references are to documents which passwed working group last call. Has normative reference to draft-ietf-nmop-message-broker-telemetry-message in NMOP.
...
* **IETF Session**: Yes, 20min, Thomas Graf, onsite, Hackathon summary
...
* **State**: Received comments from Rob, Nigel, Holger, Reshad and Loic Monney and contribution from Hellmar https://mailarchive.ietf.org/arch/msg/nmop/19cqIfn4SwgzuWUO-KYajEf_KqE/. Adoption call started at February 4th.
* **Mailinglist**: https://mailarchive.ietf.org/arch/browse/nmop/?q=draft-netana-nmop-yang-message-broker-message-key
* **Diff**: https://author-tools.ietf.org/diff?doc_1=draft-netana-nmop-yang-message-broker-message-key
* **IETF Session**: Yes, 5min, Thomas Graf, onsite
